...
function game_rules_menu_character_other(menu_entries) {
	return menu_entries;
}
...
function game_rules_menu_token_player(menu_entries) {
	return menu_entries;
}

function game_rules_menu_token_handover(menu_entries) {
	return menu_entries;
}
