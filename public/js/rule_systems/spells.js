...
function spells_sidebar_message_bbcode(tag, content) {
...
function spell_roll_dice(dice) {
	if (dungeon_master == false) {
		...
		send_message('Casting [spell]' + spell + '[/spell].', character_name);
	}
...
function spells_initialize() {
	rule_system_register_callback('sidebar_message_bbcode', spells_sidebar_message_bbcode);
