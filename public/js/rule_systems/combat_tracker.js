...
function combat_tracker_object_info(obj) {
	...
	if (obj.hasClass('character')) {
		info += _combat_initiative_label + ': ' + obj.attr('initiative') + '<br />';
	}

	return info;
}

function combat_tracker_help_dm() {
    return {
...
function combat_tracker_initialize() {
	...
	rule_system_register_callback('websocket_message', combat_tracker_websocket_message);
	rule_system_register_callback('handle_input', combat_tracker_handle_input);
	rule_system_register_callback('object_info', combat_tracker_object_info);
	rule_system_register_callback('help_dm', combat_tracker_help_dm);

	_combat_initiative_label = $('div.playarea').attr('initiative_label');
	...
	var form = '<table class="table table-condensed combat-tracker">' +
			   '<thead><tr><th>Character / group name</th><th>' + _combat_initiative_label + '</th></tr></thead>' +
