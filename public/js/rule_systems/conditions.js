function conditions_initialize() {
	...
	rule_system_register_callback('websocket_message', conditions_websocket_message);
	rule_system_register_callback('menu_character_dm', conditions_menu);
	rule_system_register_callback('menu_character_mine', conditions_menu);
	rule_system_register_callback('menu_token_dm', conditions_menu);
	rule_system_register_callback('context_menu_handler', conditions_context_menu_handler);
	rule_system_register_callback('object_info', conditions_object_info);
}
...
function conditions_menu(menu_entries, obj) {
